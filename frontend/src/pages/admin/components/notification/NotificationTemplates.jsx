...
export default function NotificationTemplates({ templates, onCreate, onUpdate, onDelete }) {
  ...
  const handleUpdate = async (id, templateData) => {
    try {
      await onUpdate(id, templateData);
      setIsModalOpen(false);
    } catch (error) {
      toast.error(error.message);
    }
    ...
    <div className="space-y-4">
      ...
      >
        <TemplateForm
          ...
          onSubmit={currentTemplate ? (data) => handleUpdate(currentTemplate._id, data) : handleCreate}
