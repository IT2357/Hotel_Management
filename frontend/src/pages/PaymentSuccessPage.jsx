    ...
    <div style={{ fontFamily: "'Rubik', sans-serif", minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      ...
      <div style={{ maxWidth: '800px', margin: '4rem auto', padding: '0 2rem', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '1.2rem', color: '#666', marginBottom: '2rem', lineHeight: '1.6' }}>
          ...
          {orderId && (
            <span style={{ display: 'block', marginTop: '1rem', fontWeight: 'bold', color: '#C41E3A' }}>
              Order ID: {orderId}
            </span>
          )}
        </p>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'left', maxWidth: '500px', margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
              <div style={{ width: '30px', height: '30px', backgroundColor: '#F59E0B', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>
                1
              </div>
              <span>Your order is being prepared by our expert chefs</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
              <div style={{ width: '30px', height: '30px', backgroundColor: '#10B981', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>
                2
              </div>
              <span>You'll receive a notification when your order is ready</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <div style={{ width: '30px', height: '30px', backgroundColor: '#C41E3A', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}>
                3
              </div>
              <span>Enjoy your authentic Jaffna Tamil cuisine!</span>
            </div>
          </div>
        </div>
