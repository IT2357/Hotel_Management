    ...
    <div style={{ fontFamily: "'Rubik', sans-serif", margin: 0, padding: 0, lineHeight: '1.6', color: '#333' }}>
      ...
      <nav style={{ background: '#f8f9fa', borderTop: '1px solid #e9ecef', padding: '1rem 0' }}>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <Link to="/gallery" style={{ textDecoration: 'none', color: '#333', fontWeight: 500 }}>Gallery</Link>
          <Link to="/blog" style={{ textDecoration: 'none', color: '#C41E3A', fontWeight: 500 }}>Blog</Link>
