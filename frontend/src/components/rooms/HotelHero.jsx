...
const HotelHero = () => {
  return (
    <section className="relative h-[90vh] min-h-[600px] overflow-hidden bg-gray-900">
        ...
        <div className="w-full max-w-5xl text-center">
          ...
          <div className="animate-fade-in">
            <div className="inline-flex items-center bg-gradient-to-r from-indigo-600/80 to-purple-600/80 text-white text-sm px-4 py-2 rounded-full mb-6 backdrop-blur-sm border border-white/10">
              ...
              <span>Luxury Redefined, Comfort Perfected</span>
            </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-1/4 -left-20 w-40 h-40 bg-purple-500/20 rounded-full filter blur-3xl"></div>
      <div className="absolute bottom-1/4 -right-20 w-60 h-60 bg-indigo-500/20 rounded-full filter blur-3xl"></div>
    </section>
  );
};
